const qnaList = [
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 붉은 노을이 생각나는 노래', score: 6 },
      { answer: 'b. 어두운 밤하늘이 떠오르는 노래', score: 7 },
      { answer: 'c. 발랄하고 청량한 노래', score: 5 },
      { answer: 'd. 싱그러운 숲속에 있는듯한 노래', score: 4 },
      { answer: 'e. 몽환적인 노래', score: 3 },
      { answer: 'f. 맑고 깨끗한 느낌의 노래', score: 2 },
      { answer: 'g. 묵직하지만 깔끔한 노래', score: 1 }
    ]
  },
  {
  ...
  // },
  {
    q: '10. 노래를 들을 때 더 중요하게 생각하는 건?',
    a: [
      { answer: 'a. 가사',score:0},
      { answer: 'b. 멜로디',score:0},
      { answer: 'c. 상관 없음',score:0},
    ]
  }
]
