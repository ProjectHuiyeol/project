...
!(function ($) {
  ...
  function LoadingWithMask(gif) {
    ...
    // 화면에 출력할 마스크 설정
    var mask =
      "<div style='background-color:#C0C0C0; opacity:'0.4''><div id='mask' style='position:absolute; z-index:9000; display:none; left:0; top:0'></div></div>"
    var loadingImg = ''
    console.log(gif)

    loadingImg += "<div id='loadingImg'>"
    loadingImg +=
      " <img name = 'img_check' src='" +
      gif +
